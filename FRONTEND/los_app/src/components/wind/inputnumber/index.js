export default {
  root: ({ props, parent }) => ({
    class: [
      ...
      {
        "ring1 ring-sf dark:ring-surface-700 ring-offset-0":
  ...
  input: {
    root: ({ parent, context }) => ({
      class: [
        ...
        "focus:outline-none focus:outline-offset-0 focus:ring-2 focus:ring-inset focus:ring-pr dark:focus:ring-primary-500",
