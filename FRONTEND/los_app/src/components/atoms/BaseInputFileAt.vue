<template>
    <div class="relative input-wrap w-full p-2 inline-block">
        <label for="cover-photo" class="flex text-reg pb-2 font-medium">Attachment</label>
        <div class="flex justify-center rounded-lg border border-dashed border-plate px-6 py-10">
