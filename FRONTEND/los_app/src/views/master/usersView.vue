...
useAPIget("users", token).then(([res]) => { tableData.value = res; suspense.value = !suspense.value; });
const heading = [{ username: "Nama Pengguna", email: "email", profile_photo_path: "Avatar", status: "Status", }];</script>