...
useAPIget("menu", token).then(([res]) => { tableData.value = res; suspense.value = !suspense.value; });
const heading = [{ menu_name: "Menu", route: "Route", parent: "PARENT", order: "order", leading: "icon", status: "status", }];</script>